            ...
            renderCell: (params) => (
                <div className='flex gap-2'>
                    <button
                        ...
                        className="p-1 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-colors duration-200"
                    >
                ...
                <Box sx={style}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            />
                            <div>
                                <div className="col-span-2 flex items-center justify-center bg-gray-100 p-3 rounded-md">
