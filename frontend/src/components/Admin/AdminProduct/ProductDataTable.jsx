  ...
  const columns = [
    ...
    { field: 'Action', headerName: 'Action', width: 120, 
        ...
        <div className='flex gap-2'>
          <button onClick={() => handleEditClick(params.row)} className="p-2 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-colors duration-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="col-span-2 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
                name="productName"
              ...
              <div className="col-span-2">
                ...
                <label
                  ...
                  className="cursor-pointer bg-gray-800 text-gray-200 rounded-md py-3 px-4 w-full inline-flex items-center justify-between border border-gray-700 hover:bg-gray-700 transition duration-300 ease-in-out"
                >
              ...
              {edit && (
                <div className="col-span-2 flex items-center justify-between bg-gray-100 p-3 rounded-md">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white p-3 rounded-md hover:bg-blue-700 transition-colors duration-300 font-medium text-lg"
            >
